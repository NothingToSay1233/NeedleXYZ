...
namespace hs {
	...
	_(should_skip_anim_frame_p, "57 8B F9 8B 07 8B 80 ? ? ? ? FF D0 84 C0 75 02"); // 57 8B F9 8B 07 8B 80 ? ? ? ? FF D0 84 C0 75 02 5F C3
	...
	/* misc */
	_(weave_su, "Needle.xyz");
	_(weave_logo, "Needle.xyz");
	...
	_(clantag7, "Needle.");
	_(clantag8, "Needle.x");
	_(clantag9, "Needle.xy");
	_(clantag10,"Needle.xyz");
	...
	_(calc_view_model_view, "55 8B EC 83 E4 F8 83 EC 24 53 56 57 FF 75 18"); // 55 8B EC 83 EC 58 56 57
